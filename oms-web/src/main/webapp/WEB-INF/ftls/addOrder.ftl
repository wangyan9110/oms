        ...
        <form action="addForm" method="post">
            <div class="form_wrap">
                ...
                <dl>
                    ...
                    <dd>
                        <input type="hidden" id="hidCustomerID" name="customerId" />
                    ...
                    <dd>
                        <input type="text" id="shipName" art="textbox" maxlength="20" required="true" name="ship.name"  />
                    </dd>
                    <dt>
                        <label art='label' required='true'>订购时间：</label></dt>
                    <dd>
                        <input type="text" id="orderDate" name="orderDate" art="datetimer" required="true" validtype="date"/>
                    </dd>
                    <dt>
                        <label art='label' required='true'>发货时间：</label></dt>
                    <dd>
                        <input type="text" id="shippedDate" name="shippedDate" required="true" validtype="date" art="datetimer" />
                    </dd>
                    <dt>
                        <label art='label' required='true'>到货时间：</label></dt>
                    <dd>
                        <input type="text" id="requiredDate" name="requiredDate" required="true" validtype="date" art="datetimer" />
                    </dd>
                    <dt>
                        <label art='label' required='true'>收货地址：</label></dt>
                    <dd>
                        <input type="text" id="shipAddress" required="true" value="" name="ship.address.address" art="textbox" emptytext="限制长度(0,30)" validtype="length[0,30]" />
                    </dd>
                    <dt>
                        <label art='label' required='true'>负责人：</label></dt>
                    <dd>
                        <input type="hidden" id="hidEmployeeID" name="employeeId" />
                    ...
                    <dd>
                        <input type="text" id="freight" name="freight" class="txt_num" value="" art="textbox" textmode="float" required="true" maxlength="10" />RMB
                    </dd>
                    <dt>
                        <label art='label' required='true'>物流：</label></dt>
                    <dd>
                        <input type="hidden" id="hidShipVia" name="shipperId" value="" />
